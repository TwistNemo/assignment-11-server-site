...
export default async function findPackageLocations(cwd) {
            ...
            if (inFlight === MAX_PARALLEL_TASKS) {
                ...
                fn((err) => {
                    ...
                    if (pending.length) {
                        ...
                        resolve(new Map([...pkgLocations].sort(([a], [b]) => (a < b ? -1 : 1))));
                    }
                });
            }
        }
                        ...
                        if (directoryName[0] === '@') {
                            ...
                            task((cb) => {
                                readdir(scopeDir, (err, directoryNames) => {
                                    ...
                                    for (const directoryName of directoryNames) {
                                        testDirectory(sourceDirectory, join(scopeDir, directoryName));
                                    }
                                    cb();
                                });
                            });
                ...
                readFile(pkgFileName, 'utf8', (err, result) => {
                    ...
                    realpath(dir, (err, resolvedPackageDirectory) => {
                        ...
                        if (existingLocation &&
                            ...
                            const { alternativeLocations, name, version, ...existingLocationProps } = existingLocation;
                            pkgLocations.set(id, {
                                name,
                                version,
                                sourceDirectory,
