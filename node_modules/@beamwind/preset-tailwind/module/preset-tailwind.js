...
var theme = {
  extend: {
    ...
    spacing: __assign(__assign(__assign(__assign(__assign({}, linear(4, "rem", 4, 0.5, 0.5)), linear(12, "rem", 4, 5)), {
      14: "3.5rem"
    ...
    rotate: __assign(__assign(__assign({}, exponential(2, "deg")), exponential(12, "deg", 3)), exponential(180, "deg", 45)),
    scale: __assign(__assign({
      0: "0",
      50: ".5",
      75: ".75"
    }, linear(110, "", 100, 90, 5)), {
    ...
    skew: __assign(__assign({}, exponential(2, "deg")), exponential(12, "deg", 3)),
    ...
    width: __assign(__assign({}, ratios(2, 6)), ratios(12, 12)),
